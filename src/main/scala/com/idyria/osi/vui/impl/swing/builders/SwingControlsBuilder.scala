...
trait SwingControlsBuilder extends ControlsBuilderInterface[Component] {
  ...
  */
   ...
   */
  def tree[CT <: TreeNode] : VUITree[CT,Component] = {

    return new SwingJComponentCommonDelegate[JTree](new JTree()) with VUITree[CT,Component] {
       ...
       * Change Model
       */
      override def setModel(model: TreeModel[CT]) = {
      ...
      override def getModel : TreeModel[CT] = this.model.model.asInstanceOf[TreeModel[CT]]

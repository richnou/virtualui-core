...
*/
  ...
  var composedViews = List[AView[T]]()
  ...
  def compose(baseClass: Class[_ <: AView[T]]): AView[T] = {
   ...
   */
  /*def apply(cl: AView[T] => SGNode[Any]) = {
...
abstract class AViewCompiler[T <: AView[_ <: SGNode[_]]] extends SourceCompiler[Class[T]] {

  implicit def viewToSGNode(v: AView[_ <: SGNode[_]]): SGNode[_] = v.render
